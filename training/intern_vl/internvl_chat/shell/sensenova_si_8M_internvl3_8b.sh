...
# ============================================================
# SenseNova-SI-8M Training with InternVL3-8B
# ============================================================
#
...
NNODES=${WORLD_SIZE:-1}
RESULTS_DIR="${RESULTS_DIR:-${TRAINING_ROOT}/results/internvl3_8b/sensenova_si_8M}"
META_PATH="${META_PATH:-${REPO_DIR}/shell/data/sensenova_si_8M.json}"
